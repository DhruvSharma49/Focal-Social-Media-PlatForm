...
// import { Heart, MessageCircle, Send, Bookmark, MoreHorizontal, Music, Volume2, VolumeX } from "lucide-react";
...
//                   }`}
//                 />
//                 <span className="text-xs text-foreground">{formatNumber(reel.likes)}</span>
//               </button>

//               <button className="flex flex-col items-center gap-1">
//                 <MessageCircle className="w-7 h-7 text-foreground" />
//                 <span className="text-xs text-foreground">{formatNumber(reel.comments)}</span>
//               </button>

//               <button className="flex flex-col items-center gap-1">
//                 <Send className="w-7 h-7 text-foreground" />
//                 <span className="text-xs text-foreground">{formatNumber(reel.shares)}</span>
//               </button>
...
import { reels } from "../data/mockData"; /* Make this path correct based on your folder structure */
      ...
      <div className="relative h-full max-h-[900px] w-full max-w-[420px] snap-y snap-mandatory overflow-y-scroll scrollbar-hide hide-scrollbar .hide-scrollbar::-webkit-scrollbar">
        {reels.map((reel) => (
          ...
          >
            {/* Background */}
            <div className="absolute inset-0 bg-secondary">
              <img src={reel.videoThumbnail} alt="" className="w-full h-full object-cover" />
              <div className="absolute inset-0 bg-gradient-to-b from-transparent via-transparent to-black/60" />
            </div>
