...
//             </div>
//             <div>
//               <span className="font-semibold text-lg">{formatNumber(userData.followersCount)}</span>{" "}
//               followers
//             </div>
//             <div>
//               <span className="font-semibold text-lg">{formatNumber(userData.followingCount)}</span>{" "}
//               following
//             </div>
//           </div>
