...
//       {/* Conversations List */}
//       <div className={`w-full md:w-[397px] border-r border-divider flex flex-col ${selectedConversation ? 'hidden md:flex' : 'flex'}`}>
//         {/* Header */}
...
//           <button className="ml-auto text-sm text-muted-foreground">Requests</button>
//         </div>
...
//                 <div>
//                   <div className="flex items-center gap-1">
//                     <span className="font-semibold">{selected.user.fullName}</span>
...
//                     {selected.isActive ? "Active now" : `Active ${selected.time} ago`}
//                   </span>
//                 </div>
//               </div>
...
//                 />
//                 {message ? (
//                   <button className="text-primary font-semibold text-sm">Send</button>
//                 ) : (
//                   <div className="flex items-center gap-3">
