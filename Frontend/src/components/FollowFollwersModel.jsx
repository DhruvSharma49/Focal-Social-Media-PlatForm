...
//       try {
//         let url = `/interact/myprofile`;
//         if (type === "followers" || type === "following") {
//           url = `/interact/otherprofile/${userId}`;
//         }
...
//         {list.length === 0 ? (
//           <p className="text-gray-500 dark:text-gray-400">No {type} yet</p>
//         ) : (
//           <ul>
//             {list.map((u) => (
//               <li
...
//                 onClick={() => {
//                   navigate(`/otherprofile/${u._id}`);
//                   onClose(); // modal close kar dein
//                 }}
//               >
//                 <img
